...
namespace NewsSite.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        private async Task SaveImage(IFormFile uploadedFile, User user)
        {
        ...
        [HttpGet]
        public async Task<IActionResult> UserArticles(string userId = null)
        {
            ...
            posts = _repository.Posts.Where(p => p.UserId == user.Id);
            return View(posts);
        }

        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Index(IndexViewModel model, IFormFile uploadedFile)
        {
